...
function renderLanguageDropdown(currentLang) {
  return `
    <div class="lang-select-wrap" dir="ltr">
      <label class="lang-select-label" for="langSelect">${htmlEscape(t(currentLang, "languageChooser"))}</label>
      <select id="langSelect" class="lang-select" aria-label="${htmlEscape(t(currentLang, "languageChooser"))}">
