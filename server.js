...
function renderLanguageDropdown(currentLang) {
  return `
    <div class="lang-select-wrap" dir="ltr">
      <div class="lang-icon-box" aria-hidden="true">
        <svg class="lang-icon" viewBox="0 0 24 24" fill="none">
          <path d="M4 5H14" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M9 5V7C9 11.4183 6.31371 15 3 15" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M9 5V7C9 11.4183 11.6863 15 15 15" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M3 19L8 8L13 19" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M4.5 15H11.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M16 7L20 17" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M22 11H14" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
      <select id="langSelect" class="lang-select" aria-label="Language">
        ${SUPPORTED_LANGS.map((langCode) => {
          ...
          return `<option value="${htmlEscape(langCode)}"${selected}>${htmlEscape(meta.label)}</option>`;
        }).join("")}
      </select>
    </div>
  `;
...
<body>
<div class="card">
  ${renderLanguageDropdown(safeLang)}
  ${body}
</div>
</body>
</html>
